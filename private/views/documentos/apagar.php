...
$db  = get_db();
$doc = $db->prepare("SELECT d.nome, e.designacao FROM documentos d JOIN equipamentos e ON d.id_equipamento=e.id WHERE d.id=?");
$doc->execute([$id]);
        ...
        <main class="col-md-9 col-lg-10 bo-content">
            <div class="d-flex justify-content-center mt-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-5" style="max-width:500px; width:100%;">
                    ...
                    <p class="mb-1 fs-5">Deseja remover este documento?</p>
                    <h4 class="mb-1"><strong><?= htmlspecialchars($doc->nome) ?></strong></h4>
                    <p class="text-muted mb-4" style="font-size:0.9rem;"><?= htmlspecialchars($doc->designacao) ?></p>
