...
$db = get_db();
$g  = $db->prepare("SELECT g.*, e.designacao FROM garantias g JOIN equipamentos e ON g.id_equipamento = e.id WHERE g.id = ?");
$g->execute([$id]);
        ...
        <main class="col-md-9 col-lg-10 bo-content">
            <div class="d-flex justify-content-center mt-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-5" style="max-width:500px; width:100%;">
                    ...
                    <p class="mb-1 fs-5">Deseja remover esta garantia?</p>
                    <h4 class="mb-4"><strong><?= htmlspecialchars($g->designacao) ?></strong></h4>
