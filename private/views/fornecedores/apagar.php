...
$db = get_db();
$f  = $db->prepare("SELECT nome, email, telefone FROM fornecedores WHERE id = ? AND deleted_at IS NULL");
$f->execute([$id]);
        ...
        <main class="col-md-9 col-lg-10 bo-content">
            <div class="d-flex justify-content-center mt-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-5" style="max-width:500px; width:100%;">
                    ...
                    <p class="mb-1 fs-5">Deseja remover este fornecedor?</p>
                    <h4 class="mb-4"><strong><?= htmlspecialchars($f->nome) ?></strong></h4>
