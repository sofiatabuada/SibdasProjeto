        ...
        <main class="col-md-9 col-lg-10 bo-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="<?= BASE_URL ?>/private/views/exportar/localizacoes_csv.php" class="btn btn-outline-secondary">
                        <i class="fa-solid fa-file-excel me-1"></i>Excel
                    </a>
                    <a href="<?= BASE_URL ?>/private/views/exportar/localizacoes_pdf.php" class="btn btn-outline-secondary" target="_blank">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            <a href="detalhes.php?id=<?= aes_encrypt($loc->id) ?>" class="btn-action btn-action-view" title="Ver detalhes">
